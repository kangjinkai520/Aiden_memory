...
早期使用暴露了一个重要风险：生成出来的 `deep-profile.md` 如果把有限的对话历史组织成一套非常顺滑的心理叙事，会显得异常有说服力。用户应该把任何生成出来的 deep profile 当作一份有日期、局部、可审阅的反思辅助，而不是诊断、人格判词或身份权威。

完整的维护者手记和设计规则见 [Deep Profile Risk](docs/deep-profile-risk.md)。
...
- [Deep Profile 风险](docs/deep-profile-risk.md)
